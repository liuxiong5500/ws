$(function () {
    ...
    $('body.ticket select[name="contactid"]').on('change', function () {
        ...
        var ticket_type = $('#ticket-type').data('type');
        if (ticket_type == 'opportunity') {
            var opportunityAjax = $('select[name="opportunity_id"]');
            var opportunityAutoSelected = opportunityAjax.attr('data-auto-opportunity');
            var opportunitiesWrapper = $('.opportunities-wrapper');
            if (!opportunityAjax.attr('disabled')) {
                var clonedOpportunitiesAjaxSearchSelect;
                if (!opportunityAutoSelected) {
                    clonedOpportunitiesAjaxSearchSelect = opportunityAjax.html('').clone();
                } else {
                    clonedOpportunitiesAjaxSearchSelect = opportunityAjax.clone();
                    clonedOpportunitiesAjaxSearchSelect.prop('disabled', true);
                }
                ...
                init_ajax_search('opportunity', opportunityAjax, {
            ...
            if (contactid != '') {
                $.post(admin_url + 'tickets/ticket_change_data/', {
                    ...
                    if (!opportunityAutoSelected) {
                        if (response.customer_has_opportunities) {
                            opportunitiesWrapper.removeClass('hide');
                        } else {
