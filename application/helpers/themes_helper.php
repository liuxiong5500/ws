...
function get_supplier_template_part($name, $data = [], $return = false)
{
    $CI = &get_instance();
    if ($return == true) {
        return $CI->load->view('supplier/template_parts/' . $name, $data, true);
    }
    $CI->load->view('supplier/template_parts/' . $name, $data);
}
