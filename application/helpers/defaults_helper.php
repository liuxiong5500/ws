...
function get_sql_select_supplier_company()
{
    return 'CASE company WHEN "" THEN (SELECT CONCAT(firstname, " ", lastname) FROM tblsuppliercontacts WHERE supplier_id = tblsuppliers.id and is_primary = 1) ELSE company END as company';
}
