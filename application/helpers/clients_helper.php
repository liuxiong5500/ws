...
function get_customer_profile_tabs($customer_id)
{
    $customer_tabs = [
        ...
        [
            'name' => 'warehouses',
            'url' => admin_url('clients/client/' . $customer_id . '?group=warehouses'),
            'icon' => 'fa fa-home',
            'lang' => _l('customer_warehouses'),
            'visible' => true,
            'order' => 3,
        ],
        [
...
function get_primary_supplier_contact_user_id($userid)
{
    $CI = &get_instance();
...
function get_supplier_default_language($supplier_id = '')
{
...
function get_contact_permissions()
{
    $permissions = [
        ...
        [
            'id' => 24,
            'name' => _l('customer_permission_opportunities'),
