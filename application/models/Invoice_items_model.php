...
class Invoice_items_model extends CRM_Model
{
    ...
    public function get($id = '')
    {
        ...
        $this->db->select($rateCurrencyColumns . 'tblitems.id as itemid,rate,
            ...
            description,long_description,group_id,tblitems_groups.name as group_name,unit,tblprocessmaster.name as process_name,tblprocessmaster.id as process_id');
        ...
        $this->db->join('tblprocessmaster', 'tblprocessmaster.id = tblitems.process_id');
