            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <?php echo render_input('rate', 'currency_list_rate'); ?>
                    </div>
                </div>
            </div>
...
<script>
    $(function () {
        initDataTable('.table-currencies', window.location.href, [3], [3]);
        _validate_form($('form'), {
        ...
        $('#currency_modal').on('show.bs.modal', function (event) {
            ...
            if (typeof(id) !== 'undefined') {
                ...
                var xrate = $(button).parents('tr').find('td').eq(3).text();
                ...
                $('#currency_modal input[name="rate"]').val(rate);
            }
        });
    });
