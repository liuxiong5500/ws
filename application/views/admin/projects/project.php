            ...
            <div class="col-md-7">
                <div class="panel_s">
                    <div class="panel-body">
                        ...
                        <div class="form-group select-placeholder opportunities-wrapper">
                            ...
                            <div id="opportunity_ajax_search_wrapper">
                                <select name="opportunity_id" id="opportunity_id"
                                        ...
                                        data-none-selected-text="<?php echo _l('dropdown_non_selected_tex'); ?>">
                                    <?php
                                    if (isset($project) && $project->opportunity_id != 0) {
                                        echo '<option value="' . $project->opportunity_id . '" selected>' . get_opportunity_name_by_id($project->opportunity_id) . '</option>';
                                    }
                                    ?>
                                </select>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group select-placeholder">
                                    ...
                                    <select name="billing_type" class="selectpicker" id="billing_type"
                                        ...
                                        <option value=""></option>
                                        <option
                                            value="1" <?php if (isset($project) && $project->billing_type == 1 || !isset($project) && $auto_select_billing_type && $auto_select_billing_type->billing_type == 1) {
                                            echo 'selected';
                                        } ?>><?php echo _l('project_billing_type_fixed_cost'); ?></option>
                                        <option
                                            value="2" <?php if (isset($project) && $project->billing_type == 2 || !isset($project) && $auto_select_billing_type && $auto_select_billing_type->billing_type == 2) {
                                            echo 'selected';
                                ...
                                <div class="form-group select-placeholder">
                                    ...
                                    <select name="status" id="status" class="selectpicker" data-width="100%"
                                        ...
                                        <?php foreach ($statuses as $status) { ?>
                                            <option
                                                value="<?php echo $status['id']; ?>" <?php if (!isset($project) && $status['id'] == 2 || (isset($project) && $project->status == $status['id'])) {
                                                echo 'selected';
                                    ...
                                    <select name="settings[<?php echo $setting; ?>][]" id="<?php echo $setting; ?>"
                                        ...
                                        <?php foreach ($tabs as $tab) {
                                            ...
                                            <?php } else {
                                                ...
                                                ?>
                                                <option
                                                    value="<?php echo $tab['name']; ?>"<?php if ($tab['name'] == 'project_overview') {
...
<script>
    ...
    <?php } ?>
    $(function () {
        init_ajax_search('opportunity', '#opportunity_id.ajax-search');
