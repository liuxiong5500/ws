                    ...
                    <div class="col-md-12">
                        ...
                        <div id="contact_email_notifications">
                            ...
                            <div class="col-md-6 row">
                                <div class="row">
                                    <div class="col-md-6 mtop10 border-right">
                                        <span><?php echo _l('opportunity'); ?></span>
                                    </div>
                                    <div class="col-md-6 mtop10">
                                        <div class="onoffswitch">
                                            <input type="checkbox" id="opportunity_emails" data-perm-id="6"
                                                   class="onoffswitch-checkbox" <?php if (isset($contact) && $contact->opportunity_emails == '1') {
                                                echo 'checked';
                                            } ?> value="opportunity_emails" name="opportunity_emails">
                                            <label class="onoffswitch-label" for="opportunity_emails"></label>
                                        </div>
                                    </div>
                                </div>
                            </div>
