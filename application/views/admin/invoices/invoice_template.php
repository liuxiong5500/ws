<div class="panel_s<?php if (!isset($invoice) || (isset($invoice) && count($invoices_to_merge) == 0 && (isset($invoice) && !(isset($invoice_from_project) || isset($invoice_from_opportunity)) && count($expenses_to_bill) == 0 || $invoice->status == 5))) {
    echo ' hide';
} ?>" id="invoice_top_info">
    <div class="panel-body">
        <div class="row">
            ...
            <?php if (!(isset($invoice_from_project) || isset($invoice_from_opportunity))) { ?>
...
<div class="panel_s invoice accounting-template">
    ...
    <div class="panel-body">
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <?php } ?>
                <?php
                if (!isset($invoice_from_opportunity)) { ?>
                    <div class="form-group select-placeholder opportunities-wrapper<?php if ((!isset($invoice)) || (isset($invoice) && !customer_has_opportunities($invoice->clientid))) {
                        echo ' hide';
                    } ?>">
                        <label for="opportunity_id"><?php echo _l('opportunity'); ?></label>
                        <div id="opportunity_ajax_search_wrapper">
                            <select name="opportunity_id" id="opportunity_id" class="opportunities ajax-search"
                                    data-live-search="true" data-width="100%"
                                    data-none-selected-text="<?php echo _l('dropdown_non_selected_tex'); ?>">
                                <?php
                                if (isset($invoice) && $invoice->opportunity_id != 0) {
                                    echo '<option value="' . $invoice->opportunity_id . '" selected>' . get_opportunity_name_by_id($invoice->opportunity_id) . '</option>';
                                }
                                ?>
                            </select>
                        </div>
    ...
    <div class="panel-body mtop10">
        <div class="row">
            ...
            <?php if (!(isset($invoice_from_project) || isset($invoice_from_opportunity)) && isset($billable_tasks)) {
                ?>
                <div class="col-md-3">
            ...
            <?php } ?>
            <div class="col-md-<?php if (!(isset($invoice_from_project) || isset($invoice_from_opportunity))) {
                echo 5;
            } else {
                echo 8;
