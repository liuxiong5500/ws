<div class="panel_s accounting-template estimate">
    <div class="panel-body">
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <div
                    class="form-group select-placeholder projects-wrapper<?php if ((!isset($estimate)) || (isset($estimate) && !customer_has_projects($estimate->clientid))) {
                        echo ' hide';
                    } ?>">
                ...
                <div
                    class="form-group select-placeholder opportunities-wrapper<?php if ((!isset($estimate)) || (isset($estimate) && !customer_has_opportunities($estimate->clientid))) {
                        echo ' hide';
                    } ?>">
                    ...
                    <div id="opportunity_ajax_search_wrapper">
                        <select name="opportunity_id" id="opportunity_id" class="opportunities ajax-search"
                                ...
                                data-none-selected-text="<?php echo _l('dropdown_non_selected_tex'); ?>">
                            <?php
                            if (isset($estimate) && $estimate->opportunity_id != 0) {
                                echo '<option value="' . $estimate->opportunity_id . '" selected>' . get_opportunity_name_by_id($estimate->opportunity_id) . '</option>';
                            }
                            ?>
                        </select>
                    </div>
                            ...
                            <div class="form-group select-placeholder">
                                ...
                                <select class="selectpicker display-block mbot15" name="status" data-width="100%"
                                    ...
                                    <?php foreach ($estimate_statuses as $status) { ?>
                                        <option
                                            value="<?php echo $status; ?>" <?php if (isset($estimate) && $estimate->status == $status) {
                                            echo 'selected';
    ...
    <?php $this->load->view('admin/estimates/_add_edit_items', ['type' => 'estimate']); ?>
    <div class="row">
        <div class="col-md-12 mtop15">
            <div class="panel-body bottom-transaction">
                ...
                <div class="btn-bottom-toolbar text-right">
                    <button type="button"
                            class="btn-tr btn btn-info mleft10 estimate-form-submit save-and-send transaction-submit"
                            style="display: none">
