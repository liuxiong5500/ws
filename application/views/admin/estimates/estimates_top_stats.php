    ...
    <div class="panel_s">
        <div class="panel-body">
            <div class="_filters _hidden_inputs hidden">
                ...
                echo form_hidden('opportunity_id');
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="progress no-margin">
                                    <div class="progress-bar progress-bar-<?php echo estimate_status_color_class($status); ?>"
                                         role="progressbar" aria-valuenow="40" aria-valuemin="0" aria-valuemax="100"
                                         style="width: 0%" data-percent="<?php echo $percent_data['percent']; ?>">
                                    </div>
                                </div>
                            </div>
                        </div>
