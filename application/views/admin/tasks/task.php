...
<div class="modal fade<?php if (isset($task)) {
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="project-details<?php if ($rel_type != 'project' && $rel_type != 'opportunity') {
                            echo ' hide';
                        } ?>">
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="rel_type" class="selectpicker" id="rel_type" data-width="100%"
                                        ...
                                        <option value="opportunity"
                                            ...
                                            } ?>><?php echo _l('opportunity'); ?></option>
    ...
    <script>
        ...
        $(function () {
            ...
            $('body').on('change', '#rel_id', function () {
                if ($(this).val() != '') {
                    ...
                    if (_rel_type.val() == 'opportunity') {
                        $.get(admin_url + 'opportunities/get_rel_opportunity_data/' + $(this).val() + '/' + taskid, function (opportunity) {
                            $("select[name='milestone']").html(opportunity.milestones);
                            if (typeof (_milestone_selected_data) != 'undefined') {
                                $("select[name='milestone']").val(_milestone_selected_data.id);
                                $('input[name="duedate"]').val(_milestone_selected_data.due_date)
                            }
                            $("select[name='milestone']").selectpicker('refresh');
                            if (opportunity.billing_type == 3) {
                                $('.task-hours').addClass('project-task-hours');
                            } else {
                                $('.task-hours').removeClass('project-task-hours');
                            }
                            init_project_details(_rel_type.val(), opportunity.allow_to_view_tasks);
                        }, 'json');
                    }
                }
            });
        ...
        function init_project_details(type, tasks_visible_to_customer) {
            ...
            if (type == 'project' || type == 'opportunity') {
