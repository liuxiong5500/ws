                            ...
                            <div role="tabpanel"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <?php if ($ticket->opportunity_id) { ?>
                                            <div class="form-group select-placeholder opportunities-wrapper<?php if ($ticket->userid == 0) {
                                                echo ' hide';
                                            } ?>">
                                                ...
                                                <div id="opportunity_ajax_search_wrapper">
                                                    <select name="opportunity_id" id="opportunity_id"
                                                            class="opportunities ajax-search" data-live-search="true"
                                                            data-width="100%"
                                                            data-none-selected-text="<?php echo _l('dropdown_non_selected_tex'); ?>">
                                                        <?php if ($ticket->opportunity_id != 0) { ?>
                                                            <option value="<?php echo $ticket->opportunity_id; ?>"><?php echo get_opportunity_name_by_id($ticket->opportunity_id); ?></option>
                                                        <?php } ?>
                                                    </select>
                                                </div>
                                            </div>
...
<script>
    $(function () {
        ...
        init_ajax_search('opportunity', 'select[name="opportunity_id"]', {
            customer_id: function () {
                return $('input[name="userid"]').val();
            }
        });
