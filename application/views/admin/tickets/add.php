            ...
            <div class="col-md-12">
                <div class="panel_s">
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-md-6">
                                <?php if ((!isset($project_id) && !isset($contact)) || (!isset($opportunity_id) && !isset($contact))) { ?>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="row" id="ticket-type" data-type="<?php echo $ticket_type; ?>">
                                ...
                                <?php if ($ticket_type == 'opportunity') { ?>
                                    <div class="form-group opportunities-wrapper hide">
                                        <label for="opportunity_id"><?php echo _l('opportunity'); ?></label>
                                        <div id="opportunity_ajax_search_wrapper">
                                            <select name="opportunity_id" id="opportunity_id"
                                                    class="opportunities ajax-search"
                                                    data-live-search="true" data-width="100%"
                                                    data-none-selected-text="<?php echo _l('dropdown_non_selected_tex'); ?>"<?php if (isset($opportunity_id)) { ?> data-auto-opportunity="true"
                                                data-opportunity-userid="<?php echo $userid; ?>"<?php } ?>>
                                                <?php if (isset($opportunity_id)) { ?>
                                                    <option value="<?php echo $opportunity_id; ?>"
                                                            selected><?php echo '#' . $opportunity_id . ' - ' . get_opportunity_name_by_id($opportunity_id); ?></option>
                                                <?php } ?>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group projects-wrapper hide">
                                        ...
                                        <div id="project_ajax_search_wrapper">
                                            <select name="project_id" id="project_id" class="projects ajax-search"
                                                    data-live-search="true" data-width="100%"
                                                    data-none-selected-text="<?php echo _l('dropdown_non_selected_tex'); ?>"<?php if (isset($project_id)) { ?> data-auto-project="true"
        ...
        $(function () {
            ...
            init_ajax_search('contact', '#contactid.ajax-search', {
                ...
                contact_userid: function () {
                    ...
                    <?php if($ticket_type == 'opportunity'){?>
                    var uid = $('select[data-auto-opportunity="true"]').attr('data-opportunity-userid');
                    <?php }else{?>
            ...
            <?php if($ticket_type == ''){?>
            <?php if(isset($opportunity_id) || isset($contact)){ ?>
            $('body.ticket select[name="contactid"]').change();
            <?php } ?>
            <?php if(isset($project_id)){ ?>
            $('body').on('selected.cleared.ajax.bootstrap.select', 'select[data-auto-opportunity="true"]', function (e) {
                $('input[name="userid"]').val('');
                $(this).parents('.opportunities-wrapper').addClass('hide');
                $(this).prop('disabled', false);
                $(this).removeAttr('data-auto-opportunity');
                $('body.ticket select[name="contactid"]').change();
            });
            <?php } ?>
            <?php }else{?>
