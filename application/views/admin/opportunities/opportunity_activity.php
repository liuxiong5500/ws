        ...
        <div class="feed-item">
            <div class="row">
                ...
                <div class="col-md-4 text-right">
                    <p class="text-muted"><?php echo _l('opportunity_activity_visible_to_customer'); ?></p>
                    <div class="pull-right">
                        <div class="onoffswitch">
                            <input type="checkbox" <?php if(!has_permission('opportunities','','create')){echo 'disabled';} ?> id="<?php echo $activity['id']; ?>" data-id="<?php echo $activity['id']; ?>" class="onoffswitch-checkbox" data-switch-url="<?php echo admin_url(); ?>opportunities/change_activity_visibility" <?php echo $checked; ?>>
