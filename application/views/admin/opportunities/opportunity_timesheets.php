...
<?php $table_data = array(
    _l('opportunity_timesheet_user'),
    _l('opportunity_timesheet_task'),
    _l('timesheet_tags'),
    _l('opportunity_timesheet_start_time'),
    _l('opportunity_timesheet_end_time'),
    _l('note'),
    _l('time_h'),
    _l('time_decimal'));
$table_data = do_action('opportunities_timesheets_table_columns',$table_data);
array_push($table_data,_l('options'));
render_datatable($table_data,'timesheets'); ?>
<?php $this->load->view('admin/opportunities/timesheet'); ?>
