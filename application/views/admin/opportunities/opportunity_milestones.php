<div class="opportunity-toggler-opts">
   ...
   <div id="kanban-params">
      <div class="checkbox mbot20 mtop20">
         <input type="checkbox" value="yes" id="exclude_completed_tasks" name="exclude_completed_tasks"<?php if($milestones_exclude_completed_tasks){echo ' checked';} ?> onclick="window.location.href = '<?php echo admin_url('opportunities/view/'.$opportunity->id.'?group=opportunity_milestones&exclude_completed='); ?>'+(this.checked ? 'yes' : 'no')">
...
<?php if($milestones_found){ ?>
<div class="opportunity-milestones-kanban">
