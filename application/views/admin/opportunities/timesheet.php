...
<div class="modal fade" id="timesheet" tabindex="-1" role="dialog">
    <div class="modal-dialog">
        <?php echo form_open(admin_url('opportunities/timesheet'),array('id'=>'timesheet_form')); ?>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="timesheet-start-end-time">
                            <div class="col-md-12">
                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                        <label class="control-label" for="start_time"><?php echo _l('opportunity_timesheet_start_time'); ?></label>
                                    </div>
                                    <div class="col-md-9">
                           ...
                           <div class="col-md-12">
                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                        <label class="control-label" for="end_time"><?php echo _l('opportunity_timesheet_end_time'); ?></label>
                                    </div>
                                    <div class="col-md-9">
                                ...
                                <div class="row">
                                    <div class="col-md-3 popover-250">
                                        <label class="control-label" for="timesheet_duration">
                                              <?php echo _l('opportunity_timesheet_time_spend'); ?>
                                        </label>
                    ...
                    <div class="col-md-9 col-md-offset-3 mbot15 mntop15">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="row">
                                    <div class="col-md-3">
                                        <label for="timesheet_task_id"><?php echo _l('opportunity_timesheet_task'); ?></label>
                                    </div>
                                    <div class="col-md-9">
                                         <div class="form-group">
                                            ...
                                            <option value=""></option>
                                            <?php $has_permission_create = has_permission('opportunities','','create');
                        ...
                        <div class="row mtop15">
                            <div class="col-md-12">
                                <div class="row">
                                    <div class="col-md-3">
                                        <label for="timesheet_staff_id"><?php echo _l('opportunity_timesheet_user'); ?></label>
                                    </div>
                                    <div class="col-md-9">
                                      <div class="form-group">
