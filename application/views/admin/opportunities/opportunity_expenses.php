      ...
      <a href="#" data-toggle="modal" data-target="#new_opportunity_expense" class="btn btn-info mbot25"><?php echo _l('new_expense'); ?></a>
      <?php } ?>
      <?php
      ...
      $data_expenses_filter['filter_table_name'] = '.table-opportunity-expenses';
      ...
      <?php
        ...
        $this->load->view('admin/expenses/table_html', array('class'=>'opportunity-expenses'));
      ?>
      <div class="modal fade" id="new_opportunity_expense" tabindex="-1" role="dialog">
        <div class="modal-dialog">
          <div class="modal-content">
            <?php echo form_open(admin_url('opportunities/add_expense'),array('id'=>'opportunity-expense-form','class'=>'dropzone dropzone-manual')); ?>
         ...
         $_customer_expense_data['userid'] = $opportunity->rel_id;
         $_customer_expense_data['company'] = $opportunity->rel_to;
         $customer_expense_data[] = $_customer_expense_data;
         echo render_select('clientid',$customer_expense_data,array('userid','company'),'expense_add_edit_customer',$opportunity->rel_id); ?>
        ...
        <?php echo form_hidden('clientid',$opportunity->rel_id); ?>
        <div class="clearfix"></div>
      </div>
