...
<div class="modal fade" id="milestone" tabindex="-1" role="dialog">
    <div class="modal-dialog">
        <?php echo form_open(admin_url('opportunities/milestone'),array('id'=>'milestone_form')); ?>
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <?php echo render_date_input('due_date','milestone_due_date','',($opportunity->deadline) ? array('data-date-end-date'=>$opportunity->deadline) : array()); ?>
                        ...
                        <?php echo render_input('milestone_order','opportunity_milestone_order',total_rows('tblmilestones',array('opportunity_id'=>$opportunity->id)) + 1,'number'); ?>
                    </div>
                </div>
            </div>
