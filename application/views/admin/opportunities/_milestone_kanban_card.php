    ...
    <div class="media">
      ...
      <div class="media-left">
        <?php if($task['current_user_is_assigned']){
         echo staff_profile_image(get_staff_user_id(),array('staff-profile-image-small pull-left'),'small',array('data-toggle'=>'tooltip','data-title'=>_l('opportunity_task_assigned_to_user')));
       }
