                    ...
                    <div class="panel-body">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group opportunities-wrapper<?php if ((!isset($credit_note)) || (isset($credit_note) && !customer_has_opportunities($credit_note->clientid))) {
                                    echo ' hide';
                                } ?>">
                                    ...
                                    <div id="opportunity_ajax_search_wrapper">
                                        <select name="opportunity_id" id="opportunity_id"
                                                ...
                                                data-none-selected-text="<?php echo _l('dropdown_non_selected_tex'); ?>">
                                            <?php
                                            if (isset($credit_note) && $credit_note->opportunity_id != 0) {
                                                echo '<option value="' . $credit_note->opportunity_id . '" selected>' . get_opportunity_name_by_id($credit_note->opportunity_id) . '</option>';
                                            }
                                            ?>
                                        </select>
                                    </div>
                            ...
                            <div class="col-md-8 text-right show_quantity_as_wrapper">
                                <div class="mtop10">
                                    ...
                                    <div class="radio radio-primary radio-inline">
                                        ...
                                        <label for="sq_3"><?php echo _l('credit_note_table_quantity_heading'); ?>
                                            /<?php echo _l('credit_note_table_hours_heading'); ?></label>
                                    </div>
                                </div>
                            </div>
                        </div>
                                                    ...
                                                    <div class="input-group-addon">
                                                        <div class="dropdown">
                                                            <a class="dropdown-toggle" href="#"
                                                               id="dropdown_menu_tax_total_type" data-toggle="dropdown"
                        ...
                        <div class="col-md-12 mtop15">
                            <div class="panel-body bottom-transaction">
                                ...
                                <div class="btn-bottom-toolbar text-right">
                                    <button type="button"
                                            class="btn-tr btn btn-info mleft10 credit-note-form-submit save-and-send transaction-submit">
