...
if ($this->ci->input->get('opportunity_id')) {
    array_push($where, 'AND tblsubscriptions.opportunity_id=' . $this->ci->input->get('opportunity_id'));
}
...
$join = [
    ...
    'LEFT JOIN tblopportunities ON tblopportunities.id = tblsubscriptions.opportunity_id',
];
...
$result = data_tables_init($aColumns, $sIndexColumn, $sTable, $join, $where, [
    ...
    'project_id',
    'tblsubscriptions.opportunity_id',
    'hash',
]);
