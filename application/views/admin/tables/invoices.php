...
$join = [
    ...
    'LEFT JOIN tblopportunities ON tblopportunities.id = tblinvoices.opportunity_id',
];
...
if ($opportunity_id) {
    array_push($where, 'AND tblinvoices.opportunity_id=' . $opportunity_id);
}
