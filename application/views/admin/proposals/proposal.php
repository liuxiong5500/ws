...
<div id="wrapper">
    <div class="content accounting-template">
        <div class="row">
                            ...
                            <div class="col-md-6 border-right">
                                ...
                                <div class="form-group select-placeholder">
                                    ...
                                    <select name="rel_type" id="rel_type" class="selectpicker" data-width="100%"
                                        ...
                                        <option value=""></option>
                                        <option
                                            value="lead" <?php if ((isset($proposal) && $proposal->rel_type == 'lead') || $this->input->get('rel_type')) {
                                            if ($rel_type == 'lead') {
                                                echo 'selected';
                                            }
                                        } ?>><?php echo _l('proposal_for_lead'); ?></option>
                                        <option
                                            value="customer" <?php if ((isset($proposal) && $proposal->rel_type == 'customer') || $this->input->get('rel_type')) {
                                ...
                                <div class="form-group select-placeholder opportunities-wrapper">
                                    ...
                                    <div id="opportunity_ajax_search_wrapper">
                                        <select name="opportunity_id" id="opportunity_id"
                                                ...
                                                data-none-selected-text="<?php echo _l('dropdown_non_selected_tex'); ?>">
                                            <?php
                                            if (isset($proposal) && $proposal->opportunity_id != 0) {
                                                echo '<option value="' . $proposal->opportunity_id . '" selected>' . get_opportunity_name_by_id($proposal->opportunity_id) . '</option>';
                                            }
                                            ?>
                                        </select>
                                    </div>
                                        ...
                                        <div class="form-group select-placeholder">
                                            ...
                                            <select name="status" class="selectpicker"
                                                ...
                                                <?php foreach ($statuses as $status) { ?>
                                                    <option
                                                        value="<?php echo $status; ?>" <?php if ((isset($proposal) && $proposal->status == $status) || (!isset($proposal) && $status == 0)) {
                                                        echo 'selected';
            ...
            <div class="col-md-12">
                <div class="panel_s">
                    <?php $this->load->view('admin/estimates/_add_edit_items', ['type' => 'proposal']); ?>
                </div>
            </div>
            <?php echo form_close(); ?>
