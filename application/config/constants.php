...
define('SUPPLIER_CONTACT_PROFILE_IMAGES_FOLDER', FCPATH . 'uploads/supplier_profile_images' . '/');
...
define('OPPORTUNITY_ATTACHMENTS_FOLDER', FCPATH . 'uploads/opportunities' . '/');
